...
\restrict zzJ2sXgAfCfX3ipLrxO7e4iIBS8ZvI9FpdsMxrZr1YrCiwU1J2oEzJpWStthOK1

-- Dumped from database version 18.0
-- Dumped by pg_dump version 18.4

-- Started on 2026-07-11 01:36:30
...
--
-- TOC entry 7 (class 2615 OID 19971)
-- Name: inventory; Type: SCHEMA; Schema: -; Owner: jos
--

CREATE SCHEMA inventory;


ALTER SCHEMA inventory OWNER TO jos;

--
-- TOC entry 6 (class 2615 OID 19966)
-- Name: util; Type: SCHEMA; Schema: -; Owner: jos
--

CREATE SCHEMA util;


ALTER SCHEMA util OWNER TO jos;

--
-- TOC entry 302 (class 1255 OID 19974)
-- Name: lock_organization_sku(integer, text); Type: FUNCTION; Schema: inventory; Owner: jos
--

CREATE FUNCTION inventory.lock_organization_sku(p_organization_id integer, p_sku text) RETURNS void
    LANGUAGE plpgsql
    AS $$
DECLARE
...
ALTER FUNCTION inventory.lock_organization_sku(p_organization_id integer, p_sku text) OWNER TO jos;

--
-- TOC entry 311 (class 1255 OID 19972)
-- Name: organization_sku_exists(integer, text, integer, integer); Type: FUNCTION; Schema: inventory; Owner: jos
--

CREATE FUNCTION inventory.organization_sku_exists(p_organization_id integer, p_sku text, p_exclude_variant_id integer DEFAULT NULL::integer, p_exclude_product_id integer DEFAULT NULL::integer) RETURNS boolean
    LANGUAGE sql STABLE
    AS $$
    SELECT EXISTS
    (
...
ALTER FUNCTION inventory.organization_sku_exists(p_organization_id integer, p_sku text, p_exclude_variant_id integer, p_exclude_product_id integer) OWNER TO jos;

--
-- TOC entry 296 (class 1255 OID 19961)
-- Name: prevent_inventory_transaction_changes(); Type: FUNCTION; Schema: public; Owner: jos
--

CREATE FUNCTION public.prevent_inventory_transaction_changes() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
    RAISE EXCEPTION
        'Inventory transactions are immutable. Create a reversal transaction instead.';
END;
$$;


ALTER FUNCTION public.prevent_inventory_transaction_changes() OWNER TO jos;

--
-- TOC entry 295 (class 1255 OID 19959)
-- Name: record_inventory_movement(integer, integer, integer, character varying, integer, integer, numeric, character varying, integer, text, integer, timestamp without time zone); Type: FUNCTION; Schema: public; Owner: jos
--

CREATE FUNCTION public.record_inventory_movement(p_organization_id integer, p_warehouse_id integer, p_variant_id integer, p_transaction_type character varying, p_quantity_change integer, p_performed_by_user_id integer DEFAULT NULL::integer, p_unit_cost numeric DEFAULT NULL::numeric, p_reference_type character varying DEFAULT NULL::character varying, p_reference_id integer DEFAULT NULL::integer, p_notes text DEFAULT NULL::text, p_reversal_transaction_id integer DEFAULT NULL::integer, p_occurred_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP) RETURNS integer
    LANGUAGE plpgsql
    AS $$
DECLARE
...
BEGIN
    ...
    IF p_quantity_change = 0 THEN
        RAISE EXCEPTION 'Inventory quantity change cannot be zero';
    END IF;

    -- Warehouse must belong to the organization.
    IF NOT EXISTS (
        SELECT 1
        ...
        RAISE EXCEPTION
            'Warehouse % does not belong to active organization %',
            p_warehouse_id,
            p_organization_id;
    END IF;

    -- Variant's parent product must belong to the organization.
    IF NOT EXISTS (
        SELECT 1
        FROM public.product_variants pv
        JOIN public.products p
        ...
        RAISE EXCEPTION
            'Variant % does not belong to active organization %',
            p_variant_id,
            p_organization_id;
    END IF;

    -- User must be an active organization member when supplied.
    ...
    -- Validate positive movement types.
    ...
    THEN
        RAISE EXCEPTION
            '% requires a positive quantity change',
            p_transaction_type;
    END IF;

    -- Validate negative movement types.
    IF p_transaction_type IN (
        'STOCK_OUT',
        'SALE',
        'RETURN_OUT',
    ...
    THEN
        RAISE EXCEPTION
            '% requires a negative quantity change',
            p_transaction_type;
    END IF;
    ...
    -- Lock the balance row against concurrent changes.
    ...
    v_new_quantity := v_quantity_on_hand + p_quantity_change;

    IF v_new_quantity < 0 THEN
        RAISE EXCEPTION
            'Insufficient inventory. Current: %, requested change: %, result: %',
            v_quantity_on_hand,
            p_quantity_change,
            v_new_quantity;
    END IF;
...
ALTER FUNCTION public.record_inventory_movement(p_organization_id integer, p_warehouse_id integer, p_variant_id integer, p_transaction_type character varying, p_quantity_change integer, p_performed_by_user_id integer, p_unit_cost numeric, p_reference_type character varying, p_reference_id integer, p_notes text, p_reversal_transaction_id integer, p_occurred_at timestamp without time zone) OWNER TO jos;

--
-- TOC entry 310 (class 1255 OID 19963)
-- Name: reverse_inventory_transaction(integer, integer, text); Type: FUNCTION; Schema: public; Owner: jos
--

CREATE FUNCTION public.reverse_inventory_transaction(p_transaction_id integer, p_performed_by_user_id integer DEFAULT NULL::integer, p_notes text DEFAULT NULL::text) RETURNS integer
    LANGUAGE plpgsql
    AS $$
DECLARE
...
BEGIN
    ...
    IF EXISTS (
        SELECT 1
        FROM public.inventory_transactions
        WHERE reversal_transaction_id = p_transaction_id
    ) THEN
        RAISE EXCEPTION
    ...
    SELECT public.record_inventory_movement(
        p_organization_id         => v_original.organization_id,
        p_warehouse_id            => v_original.warehouse_id,
        p_variant_id              => v_original.variant_id,
        p_transaction_type        => 'REVERSAL'::varchar,
        p_quantity_change         => -v_original.quantity_change,
        p_performed_by_user_id    => p_performed_by_user_id,
        p_unit_cost               => v_original.unit_cost,
        p_reference_type          => 'INVENTORY_TRANSACTION'::varchar,
        p_reference_id            => p_transaction_id,
        p_notes                   => COALESCE(
            p_notes,
            'Reversal of inventory transaction '
                || p_transaction_id
        ),
        p_reversal_transaction_id => p_transaction_id,
        p_occurred_at             => LOCALTIMESTAMP
    )
...
ALTER FUNCTION public.reverse_inventory_transaction(p_transaction_id integer, p_performed_by_user_id integer, p_notes text) OWNER TO jos;

--
-- TOC entry 294 (class 1255 OID 19266)
...
--
-- TOC entry 312 (class 1255 OID 19969)
-- Name: validate_product_organization_change(); Type: FUNCTION; Schema: public; Owner: jos
--

CREATE FUNCTION public.validate_product_organization_change() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_sku             TEXT;
...
ALTER FUNCTION public.validate_product_organization_change() OWNER TO jos;

--
-- TOC entry 313 (class 1255 OID 19964)
-- Name: validate_variant_sku(); Type: FUNCTION; Schema: public; Owner: jos
--

CREATE FUNCTION public.validate_variant_sku() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_org_id INTEGER;
...
ALTER FUNCTION public.validate_variant_sku() OWNER TO jos;

--
-- TOC entry 297 (class 1255 OID 19968)
-- Name: normalize_business_identifier(text); Type: FUNCTION; Schema: util; Owner: jos
--

CREATE FUNCTION util.normalize_business_identifier(p_value text) RETURNS text
...
ALTER FUNCTION util.normalize_business_identifier(p_value text) OWNER TO jos;
...
--
-- TOC entry 256 (class 1259 OID 19331)
...
--
-- TOC entry 255 (class 1259 OID 19330)
...
--
-- TOC entry 279 (class 1259 OID 19647)
...
--
-- TOC entry 278 (class 1259 OID 19646)
...
--
-- TOC entry 264 (class 1259 OID 19403)
...
--
-- TOC entry 222 (class 1259 OID 18963)
...
--
-- TOC entry 221 (class 1259 OID 18962)
...
--
-- TOC entry 242 (class 1259 OID 19166)
...
--
-- TOC entry 241 (class 1259 OID 19165)
...
--
-- TOC entry 228 (class 1259 OID 19023)
...
CREATE TABLE public.inventory_transactions (
    ...
    quantity_change integer CONSTRAINT inventory_transactions_quantity_not_null NOT NULL,
    notes text,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    organization_id integer NOT NULL,
    ...
    CONSTRAINT inventory_transactions_quantity_change_nonzero CHECK ((quantity_change <> 0)),
    CONSTRAINT inventory_transactions_reversal_not_self CHECK (((reversal_transaction_id IS NULL) OR (reversal_transaction_id <> transaction_id))),
    CONSTRAINT inventory_transactions_type_check CHECK (((transaction_type)::text = ANY ((ARRAY['OPENING_BALANCE'::character varying, 'STOCK_IN'::character varying, 'STOCK_OUT'::character varying, 'ADJUSTMENT'::character varying, 'PURCHASE_RECEIPT'::character varying, 'SALE'::character varying, 'RETURN_IN'::character varying, 'RETURN_OUT'::character varying, 'TRANSFER_IN'::character varying, 'TRANSFER_OUT'::character varying, 'SERVICE_CONSUMPTION'::character varying, 'COUNT_CORRECTION'::character varying, 'REVERSAL'::character varying])::text[]))),
    CONSTRAINT inventory_transactions_unit_cost_nonnegative CHECK (((unit_cost IS NULL) OR (unit_cost >= (0)::numeric)))
);
...
--
-- TOC entry 272 (class 1259 OID 19513)
...
--
-- TOC entry 271 (class 1259 OID 19512)
...
--
-- TOC entry 270 (class 1259 OID 19480)
...
--
-- TOC entry 269 (class 1259 OID 19479)
...
--
-- TOC entry 292 (class 1259 OID 19769)
-- Name: organization_users; Type: TABLE; Schema: public; Owner: jos
--
...
ALTER TABLE public.organization_users OWNER TO jos;

--
-- TOC entry 291 (class 1259 OID 19768)
-- Name: organization_users_organization_user_id_seq; Type: SEQUENCE; Schema: public; Owner: jos
--

ALTER TABLE public.organization_users ALTER COLUMN organization_user_id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.organization_users_organization_user_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- TOC entry 290 (class 1259 OID 19751)
-- Name: organizations; Type: TABLE; Schema: public; Owner: jos
--
...
ALTER TABLE public.organizations OWNER TO jos;

--
-- TOC entry 289 (class 1259 OID 19750)
-- Name: organizations_organization_id_seq; Type: SEQUENCE; Schema: public; Owner: jos
--
...
--
-- TOC entry 262 (class 1259 OID 19380)
...
--
-- TOC entry 261 (class 1259 OID 19379)
...
--
-- TOC entry 273 (class 1259 OID 19541)
...
--
-- TOC entry 250 (class 1259 OID 19271)
...
--
-- TOC entry 226 (class 1259 OID 19002)
...
--
-- TOC entry 224 (class 1259 OID 18980)
...
--
-- TOC entry 287 (class 1259 OID 19715)
...
CREATE TABLE public.warehouse_inventory (
    ...
    reorder_level integer DEFAULT 0.0000 NOT NULL,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT warehouse_inventory_quantity_on_hand_nonnegative CHECK ((quantity_on_hand >= 0)),
    CONSTRAINT warehouse_inventory_quantity_reserved_nonnegative CHECK ((quantity_reserved >= 0)),
    CONSTRAINT warehouse_inventory_reorder_level_nonnegative CHECK ((reorder_level >= 0)),
    CONSTRAINT warehouse_inventory_reserved_not_above_on_hand CHECK ((quantity_reserved <= quantity_on_hand))
);
...
--
-- TOC entry 293 (class 1259 OID 19918)
...
CREATE VIEW public.product_inventory_view AS
 SELECT p.organization_id,
    ...
    pv.size,
    pv.color,
    COALESCE((sum(wi.quantity_on_hand))::numeric, 0.0000) AS quantity_on_hand,
    COALESCE((sum(wi.quantity_reserved))::numeric, 0.0000) AS quantity_reserved,
    COALESCE((sum((wi.quantity_on_hand - wi.quantity_reserved)))::numeric, 0.0000) AS quantity_available
   FROM ((public.products p
     JOIN public.product_variants pv ON ((pv.product_id = p.product_id)))
     LEFT JOIN public.warehouse_inventory wi ON ((wi.variant_id = pv.variant_id)))
  GROUP BY p.organization_id, p.product_id, p.name, pv.variant_id, pv.sku, pv.size, pv.color;
...
--
-- TOC entry 223 (class 1259 OID 18979)
...
--
-- TOC entry 236 (class 1259 OID 19103)
...
--
-- TOC entry 235 (class 1259 OID 19102)
...
--
-- TOC entry 234 (class 1259 OID 19081)
...
--
-- TOC entry 233 (class 1259 OID 19080)
...
--
-- TOC entry 268 (class 1259 OID 19455)
...
--
-- TOC entry 266 (class 1259 OID 19427)
...
--
-- TOC entry 265 (class 1259 OID 19426)
...
--
-- TOC entry 254 (class 1259 OID 19309)
...
--
-- TOC entry 253 (class 1259 OID 19308)
...
--
-- TOC entry 238 (class 1259 OID 19128)
...
--
-- TOC entry 237 (class 1259 OID 19127)
...
--
-- TOC entry 248 (class 1259 OID 19225)
...
--
-- TOC entry 247 (class 1259 OID 19224)
...
--
-- TOC entry 246 (class 1259 OID 19203)
...
--
-- TOC entry 245 (class 1259 OID 19202)
...
--
-- TOC entry 277 (class 1259 OID 19616)
...
--
-- TOC entry 260 (class 1259 OID 19366)
...
--
-- TOC entry 259 (class 1259 OID 19365)
...
--
-- TOC entry 258 (class 1259 OID 19352)
...
--
-- TOC entry 257 (class 1259 OID 19351)
...
--
-- TOC entry 230 (class 1259 OID 19044)
...
--
-- TOC entry 229 (class 1259 OID 19043)
...
--
-- TOC entry 252 (class 1259 OID 19286)
...
--
-- TOC entry 251 (class 1259 OID 19285)
...
--
-- TOC entry 240 (class 1259 OID 19142)
...
--
-- TOC entry 239 (class 1259 OID 19141)
...
--
-- TOC entry 282 (class 1259 OID 19689)
...
--
-- TOC entry 280 (class 1259 OID 19679)
...
--
-- TOC entry 281 (class 1259 OID 19684)
...
--
-- TOC entry 244 (class 1259 OID 19186)
...
--
-- TOC entry 288 (class 1259 OID 19744)
...
--
-- TOC entry 283 (class 1259 OID 19694)
...
--
-- TOC entry 275 (class 1259 OID 19578)
...
--
-- TOC entry 285 (class 1259 OID 19704)
...
--
-- TOC entry 284 (class 1259 OID 19699)
...
--
-- TOC entry 286 (class 1259 OID 19714)
...
--
-- TOC entry 243 (class 1259 OID 19185)
...
--
-- TOC entry 5115 (class 2604 OID 19334)
...
--
-- TOC entry 5161 (class 2604 OID 19650)
...
--
-- TOC entry 5129 (class 2604 OID 19406)
...
--
-- TOC entry 5058 (class 2604 OID 18966)
...
--
-- TOC entry 5094 (class 2604 OID 19169)
...
--
-- TOC entry 5070 (class 2604 OID 19026)
...
--
-- TOC entry 5150 (class 2604 OID 19516)
...
--
-- TOC entry 5143 (class 2604 OID 19483)
...
--
-- TOC entry 5127 (class 2604 OID 19383)
...
--
-- TOC entry 5154 (class 2604 OID 19545)
...
--
-- TOC entry 5110 (class 2604 OID 19274)
...
--
-- TOC entry 5077 (class 2604 OID 19063)
...
--
-- TOC entry 5066 (class 2604 OID 19005)
...
--
-- TOC entry 5062 (class 2604 OID 18983)
...
--
-- TOC entry 5085 (class 2604 OID 19106)
...
--
-- TOC entry 5079 (class 2604 OID 19084)
...
--
-- TOC entry 5139 (class 2604 OID 19458)
...
--
-- TOC entry 5132 (class 2604 OID 19430)
...
--
-- TOC entry 5114 (class 2604 OID 19312)
...
--
-- TOC entry 5088 (class 2604 OID 19131)
...
--
-- TOC entry 5108 (class 2604 OID 19228)
...
--
-- TOC entry 5102 (class 2604 OID 19206)
...
--
-- TOC entry 5157 (class 2604 OID 19619)
...
--
-- TOC entry 5123 (class 2604 OID 19369)
...
--
-- TOC entry 5119 (class 2604 OID 19355)
...
--
-- TOC entry 5073 (class 2604 OID 19047)
...
--
-- TOC entry 5112 (class 2604 OID 19289)
...
--
-- TOC entry 5090 (class 2604 OID 19145)
...
--
-- TOC entry 5166 (class 2604 OID 19718)
...
--
-- TOC entry 5098 (class 2604 OID 19189)
...
--
-- TOC entry 5273 (class 2606 OID 19345)
...
--
-- TOC entry 5306 (class 2606 OID 19663)
...
--
-- TOC entry 5285 (class 2606 OID 19415)
...
--
-- TOC entry 5194 (class 2606 OID 19879)
-- Name: categories categories_organization_category_code_key; Type: CONSTRAINT; Schema: public; Owner: jos
--

ALTER TABLE ONLY public.categories
    ADD CONSTRAINT categories_organization_category_code_key UNIQUE (organization_id, category_code);


--
-- TOC entry 5196 (class 2606 OID 18974)
...
--
-- TOC entry 5238 (class 2606 OID 19881)
-- Name: customers customers_organization_customer_code_key; Type: CONSTRAINT; Schema: public; Owner: jos
--

ALTER TABLE ONLY public.customers
    ADD CONSTRAINT customers_organization_customer_code_key UNIQUE (organization_id, customer_code);


--
-- TOC entry 5240 (class 2606 OID 19883)
-- Name: customers customers_organization_email_key; Type: CONSTRAINT; Schema: public; Owner: jos
--

ALTER TABLE ONLY public.customers
    ADD CONSTRAINT customers_organization_email_key UNIQUE (organization_id, email);


--
-- TOC entry 5242 (class 2606 OID 19179)
...
--
-- TOC entry 5300 (class 2606 OID 19525)
...
--
-- TOC entry 5296 (class 2606 OID 19893)
-- Name: invoices invoices_organization_invoice_number_key; Type: CONSTRAINT; Schema: public; Owner: jos
--

ALTER TABLE ONLY public.invoices
    ADD CONSTRAINT invoices_organization_invoice_number_key UNIQUE (organization_id, invoice_number);


--
-- TOC entry 5298 (class 2606 OID 19494)
...
--
-- TOC entry 5317 (class 2606 OID 19780)
-- Name: organization_users organization_users_pkey; Type: CONSTRAINT; Schema: public; Owner: jos
--

ALTER TABLE ONLY public.organization_users
    ADD CONSTRAINT organization_users_pkey PRIMARY KEY (organization_user_id);


--
-- TOC entry 5319 (class 2606 OID 19782)
-- Name: organization_users organization_users_unique; Type: CONSTRAINT; Schema: public; Owner: jos
--

ALTER TABLE ONLY public.organization_users
    ADD CONSTRAINT organization_users_unique UNIQUE (organization_id, user_id);


--
-- TOC entry 5312 (class 2606 OID 19766)
-- Name: organizations organizations_code_unique; Type: CONSTRAINT; Schema: public; Owner: jos
--

ALTER TABLE ONLY public.organizations
    ADD CONSTRAINT organizations_code_unique UNIQUE (organization_code);


--
-- TOC entry 5314 (class 2606 OID 19764)
-- Name: organizations organizations_pkey; Type: CONSTRAINT; Schema: public; Owner: jos
--
...
--
-- TOC entry 5281 (class 2606 OID 19391)
...
--
-- TOC entry 5283 (class 2606 OID 19389)
...
--
-- TOC entry 5302 (class 2606 OID 19552)
...
--
-- TOC entry 5258 (class 2606 OID 19284)
...
--
-- TOC entry 5260 (class 2606 OID 19282)
...
--
-- TOC entry 5223 (class 2606 OID 19069)
...
--
-- TOC entry 5206 (class 2606 OID 19014)
...
--
-- TOC entry 5201 (class 2606 OID 19885)
-- Name: products products_organization_product_code_key; Type: CONSTRAINT; Schema: public; Owner: jos
--

ALTER TABLE ONLY public.products
    ADD CONSTRAINT products_organization_product_code_key UNIQUE (organization_id, product_code);


--
-- TOC entry 5203 (class 2606 OID 18993)
...
--
-- TOC entry 5228 (class 2606 OID 19116)
...
--
-- TOC entry 5226 (class 2606 OID 19096)
...
--
-- TOC entry 5293 (class 2606 OID 19467)
...
--
-- TOC entry 5289 (class 2606 OID 19891)
-- Name: quotes quotes_organization_quote_number_key; Type: CONSTRAINT; Schema: public; Owner: jos
--

ALTER TABLE ONLY public.quotes
    ADD CONSTRAINT quotes_organization_quote_number_key UNIQUE (organization_id, quote_number);


--
-- TOC entry 5291 (class 2606 OID 19441)
...
--
-- TOC entry 5269 (class 2606 OID 19317)
...
--
-- TOC entry 5271 (class 2606 OID 19319)
...
--
-- TOC entry 5230 (class 2606 OID 19138)
...
--
-- TOC entry 5232 (class 2606 OID 19140)
...
--
-- TOC entry 5256 (class 2606 OID 19237)
...
--
-- TOC entry 5252 (class 2606 OID 19218)
...
--
-- TOC entry 5304 (class 2606 OID 19630)
...
--
-- TOC entry 5279 (class 2606 OID 19378)
...
--
-- TOC entry 5276 (class 2606 OID 19364)
...
--
-- TOC entry 5219 (class 2606 OID 19887)
-- Name: suppliers suppliers_organization_supplier_code_key; Type: CONSTRAINT; Schema: public; Owner: jos
--

ALTER TABLE ONLY public.suppliers
    ADD CONSTRAINT suppliers_organization_supplier_code_key UNIQUE (organization_id, supplier_code);


--
-- TOC entry 5221 (class 2606 OID 19056)
...
--
-- TOC entry 5265 (class 2606 OID 19896)
-- Name: user_roles user_roles_organization_user_role_key; Type: CONSTRAINT; Schema: public; Owner: jos
--

ALTER TABLE ONLY public.user_roles
    ADD CONSTRAINT user_roles_organization_user_role_key UNIQUE (organization_id, user_id, role_id);


--
-- TOC entry 5267 (class 2606 OID 19295)
...
--
-- TOC entry 5234 (class 2606 OID 19159)
...
--
-- TOC entry 5236 (class 2606 OID 19157)
...
--
-- TOC entry 5308 (class 2606 OID 19731)
...
--
-- TOC entry 5310 (class 2606 OID 19733)
...
--
-- TOC entry 5246 (class 2606 OID 19889)
-- Name: warehouses warehouses_organization_warehouse_code_key; Type: CONSTRAINT; Schema: public; Owner: jos
--

ALTER TABLE ONLY public.warehouses
    ADD CONSTRAINT warehouses_organization_warehouse_code_key UNIQUE (organization_id, warehouse_code);


--
-- TOC entry 5248 (class 2606 OID 19199)
...
--
-- TOC entry 5286 (class 1259 OID 19876)
-- Name: idx_bookings_organization_id; Type: INDEX; Schema: public; Owner: jos
--

CREATE INDEX idx_bookings_organization_id ON public.bookings USING btree (organization_id);


--
-- TOC entry 5197 (class 1259 OID 19866)
-- Name: idx_categories_organization_id; Type: INDEX; Schema: public; Owner: jos
--
...
--
-- TOC entry 5243 (class 1259 OID 19867)
-- Name: idx_customers_organization_id; Type: INDEX; Schema: public; Owner: jos
--
...
--
-- TOC entry 5207 (class 1259 OID 19951)
-- Name: idx_inventory_transactions_organization_id; Type: INDEX; Schema: public; Owner: jos
--
...
--
-- TOC entry 5208 (class 1259 OID 19955)
-- Name: idx_inventory_transactions_performed_by_user_id; Type: INDEX; Schema: public; Owner: jos
--

CREATE INDEX idx_inventory_transactions_performed_by_user_id ON public.inventory_transactions USING btree (performed_by_user_id);


--
-- TOC entry 5209 (class 1259 OID 19956)
-- Name: idx_inventory_transactions_reference; Type: INDEX; Schema: public; Owner: jos
--

CREATE INDEX idx_inventory_transactions_reference ON public.inventory_transactions USING btree (reference_type, reference_id) WHERE ((reference_type IS NOT NULL) AND (reference_id IS NOT NULL));


--
-- TOC entry 5210 (class 1259 OID 19957)
-- Name: idx_inventory_transactions_reversal_unique; Type: INDEX; Schema: public; Owner: jos
--

CREATE UNIQUE INDEX idx_inventory_transactions_reversal_unique ON public.inventory_transactions USING btree (reversal_transaction_id) WHERE (reversal_transaction_id IS NOT NULL);


--
-- TOC entry 5211 (class 1259 OID 19258)
...
--
-- TOC entry 5212 (class 1259 OID 19953)
-- Name: idx_inventory_transactions_variant_occurred_at; Type: INDEX; Schema: public; Owner: jos
--

CREATE INDEX idx_inventory_transactions_variant_occurred_at ON public.inventory_transactions USING btree (variant_id, occurred_at DESC);


--
-- TOC entry 5213 (class 1259 OID 19952)
-- Name: idx_inventory_transactions_warehouse_id; Type: INDEX; Schema: public; Owner: jos
--
...
--
-- TOC entry 5214 (class 1259 OID 19954)
-- Name: idx_inventory_transactions_warehouse_variant; Type: INDEX; Schema: public; Owner: jos
--

CREATE INDEX idx_inventory_transactions_warehouse_variant ON public.inventory_transactions USING btree (warehouse_id, variant_id);


--
-- TOC entry 5294 (class 1259 OID 19877)
-- Name: idx_invoices_organization_id; Type: INDEX; Schema: public; Owner: jos
--
...
--
-- TOC entry 5315 (class 1259 OID 19793)
-- Name: idx_organization_users_user_id; Type: INDEX; Schema: public; Owner: jos
--
...
--
-- TOC entry 5204 (class 1259 OID 19257)
...
--
-- TOC entry 5198 (class 1259 OID 19256)
...
--
-- TOC entry 5199 (class 1259 OID 19868)
-- Name: idx_products_organization_id; Type: INDEX; Schema: public; Owner: jos
--
...
--
-- TOC entry 5224 (class 1259 OID 19875)
-- Name: idx_purchase_orders_organization_id; Type: INDEX; Schema: public; Owner: jos
--

CREATE INDEX idx_purchase_orders_organization_id ON public.purchase_orders USING btree (organization_id);


--
-- TOC entry 5287 (class 1259 OID 19873)
-- Name: idx_quotes_organization_id; Type: INDEX; Schema: public; Owner: jos
--
...
--
-- TOC entry 5253 (class 1259 OID 19260)
...
--
-- TOC entry 5254 (class 1259 OID 19261)
...
--
-- TOC entry 5249 (class 1259 OID 19259)
...
--
-- TOC entry 5250 (class 1259 OID 19874)
-- Name: idx_sales_orders_organization_id; Type: INDEX; Schema: public; Owner: jos
--

CREATE INDEX idx_sales_orders_organization_id ON public.sales_orders USING btree (organization_id);


--
-- TOC entry 5277 (class 1259 OID 19872)
-- Name: idx_service_packages_organization_id; Type: INDEX; Schema: public; Owner: jos
--

CREATE INDEX idx_service_packages_organization_id ON public.service_packages USING btree (organization_id);


--
-- TOC entry 5274 (class 1259 OID 19871)
-- Name: idx_services_organization_id; Type: INDEX; Schema: public; Owner: jos
--
...
--
-- TOC entry 5217 (class 1259 OID 19869)
-- Name: idx_suppliers_organization_id; Type: INDEX; Schema: public; Owner: jos
--
...
--
-- TOC entry 5261 (class 1259 OID 19902)
-- Name: idx_user_roles_organization_id; Type: INDEX; Schema: public; Owner: jos
--
...
--
-- TOC entry 5262 (class 1259 OID 19904)
-- Name: idx_user_roles_role_id; Type: INDEX; Schema: public; Owner: jos
--
...
--
-- TOC entry 5263 (class 1259 OID 19903)
-- Name: idx_user_roles_user_id; Type: INDEX; Schema: public; Owner: jos
--
...
--
-- TOC entry 5244 (class 1259 OID 19870)
-- Name: idx_warehouses_organization_id; Type: INDEX; Schema: public; Owner: jos
--
...
--
-- TOC entry 5379 (class 2620 OID 19268)
...
--
-- TOC entry 5384 (class 2620 OID 19269)
...
--
-- TOC entry 5383 (class 2620 OID 19962)
-- Name: inventory_transactions trg_inventory_transactions_immutable; Type: TRIGGER; Schema: public; Owner: jos
--

CREATE TRIGGER trg_inventory_transactions_immutable BEFORE DELETE OR UPDATE ON public.inventory_transactions FOR EACH ROW EXECUTE FUNCTION public.prevent_inventory_transaction_changes();


--
-- TOC entry 5385 (class 2620 OID 19767)
-- Name: organizations trg_organizations_updated_at; Type: TRIGGER; Schema: public; Owner: jos
--
...
--
-- TOC entry 5380 (class 2620 OID 19267)
...
--
-- TOC entry 5381 (class 2620 OID 19973)
-- Name: products trg_validate_product_organization_change; Type: TRIGGER; Schema: public; Owner: jos
--

CREATE TRIGGER trg_validate_product_organization_change BEFORE UPDATE OF organization_id ON public.products FOR EACH ROW EXECUTE FUNCTION public.validate_product_organization_change();


--
-- TOC entry 5382 (class 2620 OID 19965)
-- Name: product_variants trg_validate_variant_sku; Type: TRIGGER; Schema: public; Owner: jos
--

CREATE TRIGGER trg_validate_variant_sku BEFORE INSERT OR UPDATE OF sku, product_id ON public.product_variants FOR EACH ROW EXECUTE FUNCTION public.validate_variant_sku();


--
-- TOC entry 5347 (class 2606 OID 19346)
...
--
-- TOC entry 5352 (class 2606 OID 19416)
...
--
-- TOC entry 5353 (class 2606 OID 19856)
-- Name: bookings bookings_organization_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: jos
--

ALTER TABLE ONLY public.bookings
    ADD CONSTRAINT bookings_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(organization_id) ON DELETE RESTRICT;


--
-- TOC entry 5354 (class 2606 OID 19421)
...
--
-- TOC entry 5320 (class 2606 OID 19806)
-- Name: categories categories_organization_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: jos
--

ALTER TABLE ONLY public.categories
    ADD CONSTRAINT categories_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(organization_id) ON DELETE RESTRICT;


--
-- TOC entry 5336 (class 2606 OID 19811)
-- Name: customers customers_organization_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: jos
--

ALTER TABLE ONLY public.customers
    ADD CONSTRAINT customers_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(organization_id) ON DELETE RESTRICT;


--
-- TOC entry 5372 (class 2606 OID 19664)
...
--
-- TOC entry 5373 (class 2606 OID 19674)
...
--
-- TOC entry 5374 (class 2606 OID 19669)
...
--
-- TOC entry 5324 (class 2606 OID 19925)
-- Name: inventory_transactions inventory_transactions_organization_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: jos
--

ALTER TABLE ONLY public.inventory_transactions
    ADD CONSTRAINT inventory_transactions_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(organization_id) ON DELETE RESTRICT;


--
-- TOC entry 5325 (class 2606 OID 19937)
-- Name: inventory_transactions inventory_transactions_performed_by_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: jos
--

ALTER TABLE ONLY public.inventory_transactions
    ADD CONSTRAINT inventory_transactions_performed_by_user_id_fkey FOREIGN KEY (performed_by_user_id) REFERENCES public.users(user_id) ON DELETE SET NULL;


--
-- TOC entry 5326 (class 2606 OID 19942)
-- Name: inventory_transactions inventory_transactions_reversal_transaction_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: jos
--

ALTER TABLE ONLY public.inventory_transactions
    ADD CONSTRAINT inventory_transactions_reversal_transaction_id_fkey FOREIGN KEY (reversal_transaction_id) REFERENCES public.inventory_transactions(transaction_id) ON DELETE RESTRICT;


--
-- TOC entry 5327 (class 2606 OID 19037)
...
--
-- TOC entry 5328 (class 2606 OID 19930)
-- Name: inventory_transactions inventory_transactions_warehouse_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: jos
--
...
--
-- TOC entry 5364 (class 2606 OID 19526)
...
--
-- TOC entry 5365 (class 2606 OID 19531)
...
--
-- TOC entry 5366 (class 2606 OID 19536)
...
--
-- TOC entry 5360 (class 2606 OID 19502)
...
--
-- TOC entry 5361 (class 2606 OID 19497)
...
--
-- TOC entry 5362 (class 2606 OID 19861)
-- Name: invoices invoices_organization_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: jos
--

ALTER TABLE ONLY public.invoices
    ADD CONSTRAINT invoices_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(organization_id) ON DELETE RESTRICT;


--
-- TOC entry 5363 (class 2606 OID 19507)
...
--
-- TOC entry 5377 (class 2606 OID 19783)
-- Name: organization_users organization_users_organization_fk; Type: FK CONSTRAINT; Schema: public; Owner: jos
--

ALTER TABLE ONLY public.organization_users
    ADD CONSTRAINT organization_users_organization_fk FOREIGN KEY (organization_id) REFERENCES public.organizations(organization_id);


--
-- TOC entry 5378 (class 2606 OID 19788)
-- Name: organization_users organization_users_user_fk; Type: FK CONSTRAINT; Schema: public; Owner: jos
--

ALTER TABLE ONLY public.organization_users
    ADD CONSTRAINT organization_users_user_fk FOREIGN KEY (user_id) REFERENCES public.users(user_id);


--
-- TOC entry 5350 (class 2606 OID 19392)
...
--
-- TOC entry 5351 (class 2606 OID 19397)
...
--
-- TOC entry 5367 (class 2606 OID 19553)
...
--
-- TOC entry 5368 (class 2606 OID 19558)
...
--
-- TOC entry 5330 (class 2606 OID 19070)
...
--
-- TOC entry 5331 (class 2606 OID 19075)
...
--
-- TOC entry 5323 (class 2606 OID 19017)
...
--
-- TOC entry 5321 (class 2606 OID 18996)
...
--
-- TOC entry 5322 (class 2606 OID 19816)
-- Name: products products_organization_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: jos
--

ALTER TABLE ONLY public.products
    ADD CONSTRAINT products_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(organization_id) ON DELETE RESTRICT;


--
-- TOC entry 5334 (class 2606 OID 19117)
...
--
-- TOC entry 5335 (class 2606 OID 19122)
...
--
-- TOC entry 5332 (class 2606 OID 19851)
-- Name: purchase_orders purchase_orders_organization_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: jos
--

ALTER TABLE ONLY public.purchase_orders
    ADD CONSTRAINT purchase_orders_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(organization_id) ON DELETE RESTRICT;


--
-- TOC entry 5333 (class 2606 OID 19097)
...
--
-- TOC entry 5358 (class 2606 OID 19468)
...
--
-- TOC entry 5359 (class 2606 OID 19473)
...
--
-- TOC entry 5355 (class 2606 OID 19449)
...
--
-- TOC entry 5356 (class 2606 OID 19444)
...
--
-- TOC entry 5357 (class 2606 OID 19841)
-- Name: quotes quotes_organization_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: jos
--

ALTER TABLE ONLY public.quotes
    ADD CONSTRAINT quotes_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(organization_id) ON DELETE RESTRICT;


--
-- TOC entry 5345 (class 2606 OID 19325)
...
--
-- TOC entry 5346 (class 2606 OID 19320)
...
--
-- TOC entry 5340 (class 2606 OID 19238)
...
--
-- TOC entry 5341 (class 2606 OID 19243)
...
--
-- TOC entry 5339 (class 2606 OID 19846)
-- Name: sales_orders sales_orders_organization_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: jos
--

ALTER TABLE ONLY public.sales_orders
    ADD CONSTRAINT sales_orders_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(organization_id) ON DELETE RESTRICT;


--
-- TOC entry 5369 (class 2606 OID 19631)
...
--
-- TOC entry 5370 (class 2606 OID 19641)
...
--
-- TOC entry 5371 (class 2606 OID 19636)
...
--
-- TOC entry 5349 (class 2606 OID 19836)
-- Name: service_packages service_packages_organization_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: jos
--

ALTER TABLE ONLY public.service_packages
    ADD CONSTRAINT service_packages_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(organization_id) ON DELETE RESTRICT;


--
-- TOC entry 5348 (class 2606 OID 19831)
-- Name: services services_organization_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: jos
--

ALTER TABLE ONLY public.services
    ADD CONSTRAINT services_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(organization_id) ON DELETE RESTRICT;


--
-- TOC entry 5329 (class 2606 OID 19821)
-- Name: suppliers suppliers_organization_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: jos
--

ALTER TABLE ONLY public.suppliers
    ADD CONSTRAINT suppliers_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(organization_id) ON DELETE RESTRICT;


--
-- TOC entry 5342 (class 2606 OID 19897)
-- Name: user_roles user_roles_organization_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: jos
--

ALTER TABLE ONLY public.user_roles
    ADD CONSTRAINT user_roles_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(organization_id) ON DELETE RESTRICT;


--
-- TOC entry 5343 (class 2606 OID 19303)
...
--
-- TOC entry 5344 (class 2606 OID 19298)
...
--
-- TOC entry 5375 (class 2606 OID 19739)
...
--
-- TOC entry 5376 (class 2606 OID 19734)
...
--
-- TOC entry 5337 (class 2606 OID 19826)
-- Name: warehouses warehouses_organization_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: jos
--

ALTER TABLE ONLY public.warehouses
    ADD CONSTRAINT warehouses_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(organization_id) ON DELETE RESTRICT;


-- Completed on 2026-07-11 01:36:30

--
-- PostgreSQL database dump complete
--

\unrestrict zzJ2sXgAfCfX3ipLrxO7e4iIBS8ZvI9FpdsMxrZr1YrCiwU1J2oEzJpWStthOK1
